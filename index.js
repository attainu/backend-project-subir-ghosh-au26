...
app.post('/', async(req, res) => {
    ...
    email('docappsubir@outlook.com', 'The appointment', 'An appointment on your clinic',
    ...
    email(req.body.email, 'Info on the appointment', 'Your appointment', `You have tried to take out your time and have willing to have an appointment on <b>${req.body.time}</b> and soon will get a confirmation email on the real appointment time. have a good day.`)
